 ...
 */
 ...
 class Assets {
		 ...
		 public function register_scripts() {
				 // Register Scripts
				 wp_register_script( 'main-js', WPIXEL_DIR_URI . '/assets/main.js', [], filemtime( WPIXEL_DIR_PATH . '/assets/main.js' ), true );
				 wp_register_script( 'bootstrap-js', WPIXEL_DIR_URI . '/assets/src/library/js/bootstrap.min.js', [], false, true );
