...
<div id="primary">
	<main id="main" class="site-main mt-5" role="main">
		<wpixel-search class="wpixel-search row px-4">
			<wpixel-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
				<wpixel-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All filters</button></wpixel-clear-all-filters>
				<?php foreach ( $filters_data as $filter_data ) : ?>
					<wpixel-checkbox-accordion
					...
					>
						...
						<wpixel-checkbox-accordion-content class="checkbox-accordion__content">
							<?php foreach ( $filter_data['children'] as $item ) : ?>
								...
								<?php if ( ! empty( $item['label'] ) ) : ?>
									<wpixel-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
											...
											<div class="checkbox-accordion__child-content">
												<?php foreach ( $item['children'] as $child ) : ?>
													...
													<?php if ( ! empty( $child['label'] ) && ! empty( $child['value'] ) ) : ?>
														<wpixel-checkbox-accordion-child class="checkbox-accordion__child">
															<div class="checkbox-accordion__child-handle form-field">
																	...
																	<?php foreach ( $child['children'] as $grand_children ) : ?>
																		...
																		<?php if ( ! empty( $grand_children['label'] ) && ! empty( $grand_children['value'] ) ) : ?>
																			<wpixel-checkbox-accordion-child class="checkbox-accordion__child <?php echo esc_attr( $has_content_class ); ?>">
																				...
																				<?php endif; ?>
																			</wpixel-checkbox-accordion-child>
																		<?php endif; ?>
																	<?php endforeach; ?>
																</div>
															<?php endif; ?>
								...
								<?php endif; ?>
							<?php endforeach; ?>
						</wpixel-checkbox-accordion-content>
					</wpixel-checkbox-accordion>
				<?php endforeach; ?>
			</wpixel-filters>
			<div class="col-lg-9 col-md-9 col-sm-12 pb-4">
				<wpixel-results-count class="wpixel-results-count"></wpixel-results-count>
				<wpixel-results class="row"></wpixel-results>
				<wpixel-loading-more class="wpixel-loading-more"></wpixel-loading-more>
			</div>
		</wpixel-search>
	</main>
</div>
