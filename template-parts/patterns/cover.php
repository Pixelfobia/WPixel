...
<!-- wp:cover {"url":"<?php echo esc_url( WPIXEL_BUILD_IMG_URI . '/patterns/moonBG.jpg' ) ?>","id":5, "minHeight":640,"align":"full","className":"wpixel-cover"} -->
<div class="wp-block-cover alignfull has-background-dim wpixel-cover" style="background-image:url(<?php echo esc_url( WPIXEL_BUILD_IMG_URI . '/patterns/moonBG.jpg' ) ?>);min-height:640px"><div class="wp-block-cover__inner-container"><!-- wp:heading {"align":"center","level":1} -->
